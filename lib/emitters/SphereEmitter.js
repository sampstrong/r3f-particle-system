...
import { createDataTexture, createSpherePositions } from "@/_js-helpers/FBOHelpers.ts";

export default function SphereEmitter({
    radius            = 1,
    surface           = false,
    size              = 128,
    spawnRate         = 500, 
    ...
    useLayoutEffect(() => {
        const initData = createSpherePositions(size, radius, surface);
